...
public class Calculo {
	...
	//faz com que o avi�o "voe" para outra posi��o
	...
	//faz com que o avi�o altere sua rota��o
	...
	//logo � feito, x1-x2 * x1-x2 para representar o quadrado
	...
	public static InfoColisao calcularColisao(Aviao a, Aviao b) {
		...
		//converte a dire��oe em radianos e depois aplica o valor na tangente, achando assim o m 
		...
		//calcula a equa��o do aviao A e B  - (y2 - y1) = m(x2 - x1) -- com o y2 n�o "existe" podemos deixar com o valor 1
		double y = 1;
		double x = 1;
		...
		//caso a velocidade de a for maior que a b, ent�o velocidade de A - velocidade de B
